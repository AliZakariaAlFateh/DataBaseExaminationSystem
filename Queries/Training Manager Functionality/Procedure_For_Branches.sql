...
Go
create or alter proc TrainingManagerFunctionality.Add_Branch(@branch_name nvarchar(100),@branch_address nvarchar(100)
...
exec TrainingManagerFunctionality.Add_Branch @branch_name='Sohag',@branch_address='Sohag, Egypt',@manager_SSN='292043726000001'
exec TrainingManagerFunctionality.Add_Branch @branch_name='Qina',@branch_address='Qina, Egypt',@manager_SSN='292043726000001'
...
Go
create or alter proc TrainingManagerFunctionality.Update_Branch(@branch_name nvarchar(100),@New_branch_address nvarchar(100),@manager_SSN char(14))
as
begin
...
Go
create or alter proc TrainingManagerFunctionality.Delete_Branch(@branch_name nvarchar(100))as
begin
	IF EXISTS (select 1 from  Branch where branch_name=@branch_name)
	begin 
...
Go
exec TrainingManagerFunctionality.Delete_Branch @branch_name='Giza';
Go


-----------------------------------  Function for Diplay Branches  ---------------
Go
CREATE FUNCTION TrainingManagerFunctionality.Select_Branches()
RETURNS TABLE
AS
RETURN
    SELECT  *
